...
const GroceryList = (items) => {
    ...
    const submitlist = async () => {
        const response = await axiosInstance.post(`${process.env.REACT_APP_API_URL}/list/setList`, list);
    ...
    const handleInputChange = (id, newName) => {
        // while we have an html input element, it's probably a good idea to directly store the input's value to a state whenever 
        // a change happens. This is because we have to interact with the input value when making api calls to
        // the backend, ex. a POST request to submit to the database (if we are going to be using REST API)
    ...
    const handleDragEnd = (result) => {
        ...
        // make shallow copy of list. this is because directly updating states during calculation is bad practice (I think)
    ...
    return (
        <div className="grocery-list">
            ...
            <div>
                ...
                <button onClick={submitlist}>Save Grocery List</button>
                {successMessage !== '' && 
                    <p>{successMessage}</p>
                }
            </div>
